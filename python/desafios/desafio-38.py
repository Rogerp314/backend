...
opção = int(input('Escolha\n {}1{} para binário,\n {}2{} para octal\n {}3{} para hexadecimal\n Sua escolha: '.format(cor['verde'], cor['limpa'], cor['vermelho'], cor['limpa'], cor['roxo'], cor['limpa'])))
...
if opção == 1:
    ...
    print('{}[ERROR]{} O prgrama só aceita até o número 3'.format(cor['vermelho'], cor['limpa']))